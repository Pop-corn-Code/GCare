@extends('auth.verification.app')

@section('title', 'E-mail verified')
@section('content')
<div class="container">
          ...
          <div class="col-sm-10 col-md-8 col-lg-5 col-xxl-4"><a class="d-flex flex-center text-decoration-none mb-4" href="£">
            ...
            <div class="px-xxl-5">
              <div class="text-center mb-6">
                <h4 class="text-body-highlight">Well done !</h4>
                <p class="text-body-tertiary mb-5">Your email was verified with success<br class="d-sm-none"></p>
                <form class="d-flex align-items-center mb-5">
                    <input class="form-control flex-1" id="email" type="email" value="{{$email}}" placeholder="Email">
                    <button class="btn btn-primary ms-2">Login Now<span class="fas fa-chevron-right ms-2"></span></button>
