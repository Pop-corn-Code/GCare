...
<div>
    ...
    <div id="reports" data-list='{"valueNames":["title","text","priority","reportsby","reports","date"],"page":10,"pagination":true}'>
        ...
        <div class="col-12">
            ...
            <div class="mb-3"><button class="btn btn-primary me-4 btn-support-chat"><span class="fas fa-plus me-2"></span>Create Report</button><button class="btn btn-link text-body px-0"><span class="fa-solid fa-file-export fs-9 me-2"></span>Export </button></div>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    ...
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4 btn-support-chat" href="#">Purchasers and sellers</a>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Useful Solutions</a>
                    <div class="d-flex align-items-center"><span class="fa-solid fa-circle me-1 text-danger" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body lh-2">Urgent</span></div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Category Products</a>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Current Deals</a>
                    <div class="d-flex align-items-center"><span class="fa-solid fa-circle me-1 text-success" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Lost of Deals</a>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Important Accounts</a>
                    <div class="d-flex align-items-center"><span class="fa-solid fa-circle me-1 text-info" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body lh-2">Low</span></div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Analytics for Email</a>
                    <div class="d-flex align-items-center"><span class="fa-solid fa-circle me-1 text-success" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Types of Deals</a>
                    <div class="d-flex align-items-center"><span class="fa-solid fa-circle me-1 text-success" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body lh-2">Medium</span></div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-6">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-start mb-1">
                    <div class="form-check mb-0"><input class="form-check-input" type="checkbox"></div>
                    <div class="d-sm-flex align-items-center ps-2"><a class="fw-bold fs-7 lh-sm title line-clamp-1 me-sm-4" href="reports-details.html">Current Sales</a>
                    <div class="d-flex align-items-center"><span class="fa-solid fa-circle me-1 text-danger" data-fa-transform="shrink-6 up-1"></span><span class="fw-bold fs-9 text-body lh-2">Urgent</span></div>
                    </div>
                </div>
                <p class="fs-9 fw-semibold text-body ms-4 text mb-4 ps-2">Sales for Today</p>
